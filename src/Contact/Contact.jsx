      ...
      <div className="w-[40%] min-h-[80%] src-contact-content">
        ...
        <div className="w-[100%] h-[20%] flex flex-row justify-around padding-2 border border-white rounded-[10px] margin-1 shadow-box">
          <div className="w-[50%] text-center border-r-2 border-white flex flex-row justify-center items-center gap-1.5">
            <FaPhoneAlt />
            <h2 className='font-[Righteous] font-bold text-[14px] text-white src-contact-info'>Phone: <span className='font-normal text-[14px] text-white src-contact-info-span'>+92 319 1084949</span></h2>
          </div>
          <div className="w-[50%] text-center flex flex-row justify-center items-center gap-1.5">
            <MdEmail />
            <h2 className='font-[Righteous] font-bold text-[14px] text-white src-contact-info'>Gmail: <span className='font-normal text-[14px] text-white src-contact-info-span'>aaliyandev786@gmail.com</span></h2>
          </div>
        </div>
