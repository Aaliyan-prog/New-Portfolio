    ...
    <div className="w-[100%] min-h-[100vh] p-[20px] flex justify-center items-center">
      <div className="w-[80%] flex justify-center items-center flex-col">
        <div className="w-[100%] h-[100px] flex justify-between items-center padding-1">
          <h2 className="text-[38px] text-theme font-bold font-[Righteous] src-pro-heading">My Resume</h2>
          <Link to="/" className="min-w-[100px] h-[40px] flex justify-content items-center border border-white rounded-[10px] font-[Righteous] text-white text-[15px] hover:bg-theme hover:border-none transition duration-1000 padding">Get Back
          ...
          {Skill.map((skills) => (
            <div className='w-[300px] h-[130px] border border-white rounded-[20px] resume-margin shadow-box src-skill-resume'>
              <div className="w-[100%] flex justify-between flex-row">
                <p className='text-white text-[20px] font-[Righteous] font-normal'>{skills.skill}</p>
                <div className="flex flex-col items-center">
                  <p className='text-white text-[18px] font-[Righteous] font-normal'>{skills.Experience}</p>
