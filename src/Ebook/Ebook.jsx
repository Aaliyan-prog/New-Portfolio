          ...
          <div className="w-[100%] h-[100%] flex flex-col justify-center items-center margin-2">
            <div className="w-[80%] h-[100%] flex flex-col justify-center items-center">
              ...
              <div className="w-[100%] flex flex-col justify-center items-center">
                ...
                <div className="w-[60%] flex flex-col justify-center items-start src-book-desc">
                  ...
                  <Link to={book.Link} className='w-[100%] h-[40px] flex justify-center items-center font-[Righteous] font-bold bg-theme text-white text-[16px] rounded-[10px] border-none margin-bottom-1 src-book-val'>{book.button_val}</Link>
                </div>
              </div>
            </div>
        </div>
