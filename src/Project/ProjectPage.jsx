    ...
    <div className="w-[100%] min-h-[100vh] p-[20px] flex justify-center items-center">
      <div className="w-[80%] flex justify-center items-center flex-col">
        <div className="w-[100%] h-[100px] flex justify-between items-center padding-1">
          <h2 className="lg:text-[38px] text-theme font-bold font-[Righteous] sm:text-[30px]">My Projects</h2>
          <Link to="/" className="min-w-[100px] h-[40px] flex justify-content items-center border border-white rounded-[10px] font-[Righteous] text-white lg:text-[15px] hover:bg-theme hover:border-none transition duration-1000 padding sm:text-[12px]">Get Back
