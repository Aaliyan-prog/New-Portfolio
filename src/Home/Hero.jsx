    ...
    <div className='w-[100%] h-[100vh] flex justify-center items-center'>
      <div className="flex flex-col justify-center items-center w-[100%] h-[100%]">
        ...
        <div className="w-[350px] flex flex-row justify-between items-center src-button-w">
          <Link to="/projects" className='w-[140px] h-[45px] bg-theme text-white text-[13px] font-bold font-[Righteous] rounded-[10px] button flex justify-center items-center hero-btn'>Project</Link>
          <Link to="/Resume" className="w-[140px] h-[45px] bg-theme text-white text-[13px] font-bold font-[Righteous] rounded-[10px] button flex justify-center items-center hero-btn">Resume</Link>
        </div>
      </div>
